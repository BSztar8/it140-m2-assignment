"""Calculates a user's birth year using their name and age.
...
Output:
    A personalized message containing the user's name and birth year.

Typical usage example:
    What is your name? Bryce
    How old are you? 36
    Hello Bryce! You were born in 1990.
"""
# === Imports ===
